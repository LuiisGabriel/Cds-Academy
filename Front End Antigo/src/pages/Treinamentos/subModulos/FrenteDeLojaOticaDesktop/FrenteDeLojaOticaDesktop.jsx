...
import getVideosRetaguardaWebCadastros from '../../../../querys/getVideos/RetaguardaWeb/GetVideosRetaguardaWebCadastros';


const FrenteDeLojaOticaDesktop = () => {
  const { loading, error, data } = useQuery(getVideosRetaguardaWebCadastros);
...
export default FrenteDeLojaOticaDesktop