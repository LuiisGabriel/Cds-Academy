...
import getVideosFrenteDeLojaWebOperacoes from '../../../../querys/getVideos/FrenteDeLojaWeb/GetVideosFrenteDeLojaWebOperacoes';


const FrenteDeLojaWebOperacoes = () => {
  const { loading, error, data } = useQuery(getVideosFrenteDeLojaWebOperacoes);
...
export default FrenteDeLojaWebOperacoes