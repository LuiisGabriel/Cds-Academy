...
import getVideosFrenteDeLojaWebRelatorios from '../../../../querys/getVideos/FrenteDeLojaWeb/GetVideosFrenteDeLojaWebRelatorios';


const FrenteDeLojaWebRelatorios = () => {
  const { loading, error, data } = useQuery(getVideosFrenteDeLojaWebRelatorios);
...
export default FrenteDeLojaWebRelatorios