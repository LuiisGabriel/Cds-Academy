...
import getVideosRetaguardaDesktopFinanceiro from '../../../../querys/getVideos/RetaguardaDesktop/GetVideosRetaguardaDesktopFinanceiro';


const RetaguardaDesktopFinanceiro = () => {
  const { loading, error, data } = useQuery(getVideosRetaguardaDesktopFinanceiro);
...
export default RetaguardaDesktopFinanceiro