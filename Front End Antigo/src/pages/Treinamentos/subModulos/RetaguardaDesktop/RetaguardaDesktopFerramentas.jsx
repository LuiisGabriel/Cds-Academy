...
import getVideosRetaguardaDesktopFerramentas from '../../../../querys/getVideos/RetaguardaDesktop/GetVideosRetaguardaDesktopFerramentas';


const RetaguardaDesktopFerramentas = () => {
  const { loading, error, data } = useQuery(getVideosRetaguardaDesktopFerramentas);
