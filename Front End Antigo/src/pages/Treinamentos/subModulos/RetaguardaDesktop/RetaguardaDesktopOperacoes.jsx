...
import getVideosRetaguardaDesktopOperacoes from '../../../../querys/getVideos/RetaguardaDesktop/GetVideosRetaguardaDesktopOperacoes';

const RetaguardaDesktopOperacoes = () => {
  const { loading, error, data } = useQuery(getVideosRetaguardaDesktopOperacoes);
...
export default RetaguardaDesktopOperacoes