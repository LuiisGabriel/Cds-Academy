...
import getVideosRetaguardaWebFinanceiro from '../../../../querys/getVideos/RetaguardaWeb/GetVideosRetaguardaWebFinanceiro';


const RetaguardaWebFinanceiro = () => {
  const { loading, error, data } = useQuery(getVideosRetaguardaWebFinanceiro);
...
export default RetaguardaWebFinanceiro