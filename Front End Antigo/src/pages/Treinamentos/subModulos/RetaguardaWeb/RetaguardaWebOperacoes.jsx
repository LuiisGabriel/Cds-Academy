...
import getVideosRetaguardaWebOperacoes from '../../../../querys/getVideos/RetaguardaWeb/GetVideosRetaguardaWebOperacoes';

const RetaguardaWebOperacoes = () => {
  const { loading, error, data } = useQuery(getVideosRetaguardaWebOperacoes);
...
export default RetaguardaWebOperacoes