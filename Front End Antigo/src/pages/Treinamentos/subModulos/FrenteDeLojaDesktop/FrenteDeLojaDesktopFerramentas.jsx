...
import getVideosFrenteDeLojaDesktopFerramentas from "../../../../querys/getVideos/FrenteDeLojaDesktop/GetVideosFrenteDeLojaDesktopFerramentas"

const FrenteDeLojaDesktopFerramentas = () => {
  const { loading, error, data } = useQuery(getVideosFrenteDeLojaDesktopFerramentas);
...
export default FrenteDeLojaDesktopFerramentas