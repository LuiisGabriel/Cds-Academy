...
import getVideosFrenteDeLojaDesktopRelatorios from '../../../../querys/getVideos/FrenteDeLojaDesktop/GetVideosFrenteDeLojaDesktopRelatorios';


const FrenteDeLojaDesktopRelatorios = () => {
  const { loading, error, data } = useQuery(getVideosFrenteDeLojaDesktopRelatorios);
...
export default FrenteDeLojaDesktopRelatorios