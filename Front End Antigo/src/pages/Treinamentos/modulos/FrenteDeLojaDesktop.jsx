...
const treinamentos = [
  {
    id: 1,
    name: 'Relatorios',
    href: '/FrenteDeLojaDesktop/Relatorios',
    imageSrc: '',
    imageAlt: 'Relatorios',
  ...
  },
  {
    id: 2,
    name: 'Operações',
    href: '/FrenteDeLojaDesktop/Operacoes',
    imageSrc: '',
    imageAlt: 'Operações',
...

  {
    id: 3,
    name: 'Ferramentas',
    href: '/FrenteDeLojaDesktop/Ferramentas',
    imageSrc: '',
...
export default FrenteDeLojaDesktop